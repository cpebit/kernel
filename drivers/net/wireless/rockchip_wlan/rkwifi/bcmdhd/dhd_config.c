...
const cihp_name_map_t chip_name_map[] = {
	...
	{BCM4345_CHIP_ID,	6,	DONT_CARE,	"ap6255_ag",	    "ap6255"},
	{BCM43454_CHIP_ID,	6,	DONT_CARE,	"ap6254_ag",	    "ap6254"},
	{BCM4345_CHIP_ID,	9,	DONT_CARE,	"ap6256_ag",	    "ap6256"},
...
dhd_conf_preinit(dhd_pub_t *dhd)
{
	...
	if (conf->chip == BCM43362_CHIP_ID || conf->chip == BCM4330_CHIP_ID) {
		...
		conf->cspec.rev = 0;
			...
			conf->chip == BCM43454_CHIP_ID || conf->chip == BCMA804_CHIP_ID) {
	...
	if (conf->chip == BCM43012_CHIP_ID ||
			...
			conf->chip == BCM4354_CHIP_ID || conf->chip == BCM4356_CHIP_ID ||
			conf->chip == BCM4345_CHIP_ID || conf->chip == BCM4371_CHIP_ID ||
			conf->chip == BCM4359_CHIP_ID || conf->chip == BCMA804_CHIP_ID) {
		conf->intr_extn = TRUE;
	}
#endif
