...
const cihp_name_map_t chip_name_map [] = {
	...
	{BCM4345_CHIP_ID,	6,	DONT_CARE,	FALSE,	"ap6255_ag",	    "ap6255"},
	{BCM43454_CHIP_ID,	6,	DONT_CARE,	FALSE,	"ap6254_ag",	    "ap6254"},
	{BCM4345_CHIP_ID,	9,	DONT_CARE,	FALSE,	"ap6256_ag",	    "ap6256"},
...
dhd_conf_preinit(dhd_pub_t *dhd)
{
	...
	if (conf->chip == BCM43362_CHIP_ID || conf->chip == BCM4330_CHIP_ID) {
		...
		conf->cspec.rev = 0;
			...
			conf->chip == BCM4362_CHIP_ID || conf->chip == BCM43454_CHIP_ID) {
